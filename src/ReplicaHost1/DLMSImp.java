        ...
        try {
            ...
            while (true) {
                ...
                switch (params[0].trim()) {
                    ...
                    case "return":
                        rtnMsg = returnInLocal(params[1], params[2]); break;
                    case "putInWaiting":
                        rtnMsg = putInWaiting(params[1], params[2]); break;
                    case "findInLocal":
                        rtnMsg = findInLocal(params[1], params[2]); break;
                    case "checkIfRtnAvailLocal":
                        rtnMsg = checkIfRtnAvailLocal (params[1], params[2]); break;
                    case "checkAndBorrowInlocal":
                        rtnMsg = checkAndBorrowInlocal(params[1], params[2], params[3]); break;
                    case "ex_putInWaiting":
                        rtnMsg = ex_putInWaiting(params[1], params[2], params[3]); break;
                    case "availableInLocal":
                        rtnMsg = availableInLocal(params[1]); break;
                    default: rtnMsg = "";
                }
