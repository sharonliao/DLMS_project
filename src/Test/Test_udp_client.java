...
//            System.out.println("Reply received from the server is: "+ returnMsg);
    ...
    public static void main(String[] args) {
        ...
        messages.add("borrowItem,MONU0001,MON1111");
        messages.add("borrowItem,CONU0001,MCG2222");
        messages.add("borrowItem,CONU0001,MON1111");
        messages.add("returnItem,MONU0001,MON1111");
        messages.add("exchangeItem,CONU0001,MON2222,MON1111");
        messages.add("listItem,CONM0001");
        messages.add("exchangeItem,CONU0001,MON2222,MON1111");
