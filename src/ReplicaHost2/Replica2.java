...
public class Replica2 {
	...
	/*
	 * public void startServers(){ Runnable start_CON_UDP = () -> { try{
	 * conServer.udpServer(); }catch (Exception e) { // TODO Auto-generated catch
	 * block e.printStackTrace(); } };
	 * 
	 * Runnable start_MCG_UDP = () -> { try{ mcgServer.udpServer();
	 * 
	 * }catch (Exception e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } };
	 * 
	 * Runnable start_MON_UDP = () -> { try{ monServer.udpServer(); }catch
	 * (Exception e) { // TODO Auto-generated catch block e.printStackTrace(); } };
	 * 
	 * Thread Thread2 = new Thread(start_CON_UDP); Thread Thread3 = new
	 * Thread(start_MCG_UDP); Thread Thread4 = new Thread(start_MON_UDP); //Thread
	 * Thread5 = new Thread(failureListener);
	 * 
